...
_SIMPLE_PHRASE_BY_METRIC = {
    "posture_accuracy": "Maintain aligned posture throughout the movement.",
    "knee_alignment_score": "Maintain knee alignment over the toes.",
    "squat_depth": "Control squat depth through the full range.",
    "torso_alignment": "Stabilize the torso before initiating movement.",
    "hip_stability": "Keep the hips centered and level.",
    "repetition_consistency": "Maintain consistent knee alignment across the set.",
    "balance_stability": "Control the finish position before resetting.",
    "elbow_angle_consistency": "Maintain a consistent elbow path.",
    "shooting_alignment": "Keep the release aligned with the target line.",
    "shoulder_control": "Maintain controlled shoulder positioning.",
    "elbow_extension": "Complete the reach through the finish.",
    "wrist_elbow_alignment": "Stack the wrist over the elbow.",
    "lockout_control": "Control the overhead lockout.",
    "shoulder_symmetry": "Move both shoulders symmetrically.",
    "stance_width_control": "Maintain a stable defensive base.",
    "knee_flexion": "Stay loaded with consistent knee bend.",
    "hip_level_stability": "Maintain low, level hip positioning.",
    "plant_foot_alignment_ratio": "Plant the support foot beside the ball.",
    "instep_backswing_knee_angle": "Control the backswing before striking.",
    "instep_contact_extension": "Extend through the ball at contact.",
    "instep_torso_tilt": "Keep the chest over the plant leg.",
    "instep_follow_through_stability": "Finish the follow-through toward the target.",
    "support_foot_distance_ratio": "Set the plant foot before swinging.",
    "shooting_knee_load": "Load the kicking knee before contact.",
    "shooting_swing_velocity": "Accelerate after the plant is stable.",
    "shooting_contact_extension": "Drive through contact with control.",
    "torso_rotation_stability": "Keep trunk rotation controlled.",
    "shooting_balance": "Control the finish before resetting.",
}
